...
const CardUploadStruk = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      await axios.delete(
        `${process.env.REACT_APP_API_URL}/upload-file/${batchToDelete}`,
      );
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isCsv) {
      showNotification(
        "warning",
        "Format Salah",
        "File yang diupload harus berformat .csv!",
      );
      return;
    }
    ...
    try {
        ...
        showNotification(
          ...
          <div>
            ...
            {duplicates && duplicates.length > 0 && (
              ...
              >
                <strong>Contoh Ref No Duplikat:</strong>
                <br />
      ...
      showNotification(
        "danger",
        "Error Sistem",
        "Terjadi error saat menghubungi server.",
      );
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <Container className="p-3">
      ...
      >
        ...
        <Modal.Body>Apakah Anda yakin ingin menghapus history ini?</Modal.Body>
          ...
          <Card.Body>
            <Form className="row text-blue" onSubmit={handleSubmit}>
              ...
              <div className="col-12 d-flex justify-content-end">
                <Button type="submit" disabled={isLoading} className="btn mt-4">
                  {isLoading ? (
                    <>
                      <LoadingIndicator
                        animation="border"
